...
```tsx
<Flex row gap={4} alignItems="center" justifyContent="between">
...
| `alignItems` | `start` \| `center` \| `end` \| `stretch` \| `baseline` — same tokens as `flex()` |
| `justifyContent` | `start` \| `center` \| `end` \| `between` \| `around` \| `evenly` — same tokens as `flex()` |
