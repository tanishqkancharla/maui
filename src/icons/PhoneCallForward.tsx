...
export const PhoneCallForward = createIcon('PhoneCallForward', function PhoneCallForward(props) {
	return (
		<svg focusable="false" aria-hidden="true" role="img" fill="none" viewBox="0 0 24 24" {...props}>
			...
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16.75 4.75L19.25 7M19.25 7L16.75 9.25M19.25 7H13.75" />
		</svg>
	)
})
