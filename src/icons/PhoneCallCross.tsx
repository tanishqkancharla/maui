...
export const PhoneCallCross = createIcon('PhoneCallCross', function PhoneCallCross(props) {
	return (
		<svg focusable="false" aria-hidden="true" role="img" fill="none" viewBox="0 0 24 24" {...props}>
			...
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.25 8.25L15.75 4.75" />
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.75 8.25L19.25 4.75" />
		</svg>
	)
})
