...
export const ColumnsVertical = createIcon('ColumnsVertical', function ColumnsVertical(props) {
	return (
		<svg focusable="false" aria-hidden="true" role="img" fill="none" viewBox="0 0 24 24" {...props}>
			...
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 5V19" />
		</svg>
	)
})
