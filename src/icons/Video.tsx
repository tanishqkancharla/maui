...
export const Video = createIcon('Video', function Video(props) {
	return (
		<svg focusable="false" aria-hidden="true" role="img" fill="none" viewBox="0 0 24 24" {...props}>
			...
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.25 12L9.75 8.75V15.25L15.25 12Z" />
		</svg>
	)
})
