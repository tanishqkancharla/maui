...
export const PhoneCallIncoming = createIcon('PhoneCallIncoming', function PhoneCallIncoming(props) {
	return (
		<svg focusable="false" aria-hidden="true" role="img" fill="none" viewBox="0 0 24 24" {...props}>
			...
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.25 4.75L14.75 9.25" />
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M14.75 5.75V9.25H18.25" />
		</svg>
	)
})
