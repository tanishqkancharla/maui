...
export const Bacteria = createIcon('Bacteria', function Bacteria(props) {
	return (
		<svg focusable="false" aria-hidden="true" role="img" viewBox="0 0 24 24" fill="none" {...props}>
			...
			<path d="M12.75 12C12.75 12.6904 13.3096 13.25 14 13.25C14.6904 13.25 15.25 12.6904 15.25 12C15.25 11.3096 14.6904 10.75 14 10.75C13.3096 10.75 12.75 11.3096 12.75 12Z" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
		</svg>
	)
})
