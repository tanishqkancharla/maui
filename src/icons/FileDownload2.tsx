...
export const FileDownload2 = createIcon('FileDownload2', function FileDownload2(props) {
	return (
		<svg focusable="false" aria-hidden="true" role="img" viewBox="0 0 24 24" fill="none" {...props}>
			...
			<path d="M9.75 16.75L12 19.25L14.25 16.75" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
		</svg>
	)
})
