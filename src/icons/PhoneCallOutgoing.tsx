...
export const PhoneCallOutgoing = createIcon('PhoneCallOutgoing', function PhoneCallOutgoing(props) {
	return (
		<svg focusable="false" aria-hidden="true" role="img" fill="none" viewBox="0 0 24 24" {...props}>
			...
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.25 8.25V4.75H15.75" />
		</svg>
	)
})
