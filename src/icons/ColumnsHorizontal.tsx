...
export const ColumnsHorizontal = createIcon('ColumnsHorizontal', function ColumnsHorizontal(props) {
	return (
		<svg focusable="false" aria-hidden="true" role="img" fill="none" viewBox="0 0 24 24" {...props}>
			...
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 12L5 12" />
		</svg>
	)
})
