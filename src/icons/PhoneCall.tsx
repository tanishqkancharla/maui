...
export const PhoneCall = createIcon('PhoneCall', function PhoneCall(props) {
	return (
		<svg focusable="false" aria-hidden="true" role="img" fill="none" viewBox="0 0 24 24" {...props}>
			...
			<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M14 5.02936C16.4312 5.72562 18.3396 7.65944 19 10.1056" />
		</svg>
	)
})
